...
namespace Unity
{
	...
	public:
		...
		Unity::CGameObject* Instantiate(Unity::CTransform* parent)
		{
			typedef Unity::CGameObject* (__fastcall* InstantiateFunc)(Unity::CGameObject*, Unity::CTransform*);
			return ((InstantiateFunc)(Offsets::Get()->ObjectInstantinateWithTransform))(this, parent);
		}

		Unity::CGameObject* Instantiate(Unity::CComponent* parent)
		{
			typedef Unity::CGameObject* (__fastcall* InstantiateFunc)(Unity::CGameObject*, Unity::CComponent*);
			return ((InstantiateFunc)(Offsets::Get()->ObjectInstantinateWithTransform))(this, parent);
		}
